<template>
  <v-container>
    <v-sheet height="600" class="pa-4 rounded-lg mb-2">
      <v-calendar
        ref="calendar"
        v-model="value"
      ...
      <div class="flex-column pa-4">
        <div class="d-flex align-center mb-3">
          ...
          <v-dialog v-model="dialog" width="500">
            ...
            <v-card>
              ...
              <v-card-text>
                <div class="flex-column">
                  ...
                  <v-form class="d-flex align-center">
                    ...
                    <v-icon
                      large
                      class="my-auto ml-3 darkgrey--text"
                      @click="swap()"
                    >
                      mdi-swap-vertical
                    </v-icon>
                  ...
                  <div class="d-flex justify-space-between align-center mb-2">
                    ...
                    >
                      <template v-slot:activator="{ on, attrs }">
                        <v-btn v-model="date1" v-bind="attrs" v-on="on" text>{{
                          date1
                        }}</v-btn>
                      </template>
                      <v-date-picker
                  ...
                  <div class="d-flex justify-space-between align-center">
                    ...
                    >
                      <template v-slot:activator="{ on, attrs }">
                        <v-btn v-model="date2" v-bind="attrs" v-on="on" text>{{
                          date2
                        }}</v-btn>
                      </template>
                      <v-date-picker
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="grey" fab small @click="test" class="my-2">
        ...
        <div v-for="(event, e) of events" :key="e">
          <div class="d-flex justify-space-between align-center">
            ...
            <div>
              <div
                :style="`height: 30px; width: 30px;border-radius: 50%; background-color: ${event.color};`"
              ></div>
            </div>
          </div>
