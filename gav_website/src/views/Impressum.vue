<template>
  <div class="impressum">
    ...
    <v-container>
      <div class="text-h4 font-weight-bold my-12 text-center">
        Impressum und Datenschutzerklärung
      </div>
      <div class="text-h6 font-weight-bold mb-4">Höhere Technische Lehranstalt Wien West</div>
      <p>
        Thaliastraße 125 <br />
        1160 Wien <br />
        Österreich
      ...
      <p>
        Telefon: +43 (01) 49 111-113 <br />
        Fax: +43 (01) 49 111-199 <br />
        E-Mail: direktion@htlwienwest.at
      </p>
      <p>Quelle: Erstellt mit dem Impressum Generator von firmenwebseiten.at</p>
      <!-- Bildernachweis -->
      <div class="text-h6 font-weight-bold mb-4">Bildernachweis</div>
      <p>
        Die Bilder, Fotos und Grafiken auf dieser Webseite sind urheberrechtlich geschützt.
      </p>
      <p>
        Die Bilderrechte liegen bei dem folgendem Fotografen und der folgenden Grafikern: <br />
        Leopold Urteil (Fotograf)
        <br />
        Jovana Stevic (Grafikerin)
      </p>
      <!-- Technische Umsetzung -->
      <div class="text-h6 font-weight-bold mb-4">Technische Umsetzung</div>
      <p>
        Si Yu Sun
      </p>
      <!-- Haftungsausschluss -->
      <div class="text-h6 font-weight-bold mb-4">Haftungsausschluss</div>
      <p>
        Haftungsausschluss Der Webauftritt der Diplomarbeit "Get Around - Vienna" hat das Ziel, die
        Öffentlichkeit über die Diplomarbeit und das Team dahinter zu informieren.
      </p>
      <p>
        Sollten Sie Fehler oder Irrtümer entdecken, bitten wir Sie, diese an Si Yu Sun (<a
          class="text-decoration-none"
          href="mailto:sun.s02@htlwienwest.at"
          >sun.s02@htlwienwest.at</a
        >) zu melden. Wir werden uns bemühen, diese rasch zu korrigieren.
      </p>
      <p>
        ...
        seitens der Autoren kein nachweislich vorsätzliches oder grob fahrlässiges Verschulden
        vorliegt.
      </p>
      <!-- Verweise und Links -->
      <div class="text-h6 font-weight-bold mb-4">Verweise und Links</div>
      <p>
        ...
        zu verhindern. Die Autoren erklären daher ausdrücklich, dass zum Zeitpunkt der Linksetzung
        die entsprechenden verlinkten Seiten frei von illegalen Inhalten waren.
      </p>
      <p>
        Die Autoren haben keinerlei Einfluss auf die aktuelle und zukünftige Gestaltung und auf die
        Inhalte der gelinkten/verknüpften Seiten. Deshalb distanzieren sie sich hiermit ausdrücklich
        ...
        Links und Verweise sowie für Fremdeinträge in von den Autoren eingerichteten
        Diskussionsforen. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für
      ...
      <!-- Urheberrecht -->
      <div class="text-h6 font-weight-bold mb-4">Urheberrecht</div>
      <p>
      ...
      <!-- Kommunikation -->
      <div class="text-h6 font-weight-bold mb-4">Kommunikation</div>
      <p>
        Kommunikation Zusammenfassung <br />
        👥 Betroffene: Alle, die mit uns per E-Mail oder Online-Formular kommunizieren <br />
        📓 Verarbeitete Daten: z. B. Name, E-Mail-Adresse, eingegebene Formulardaten. Mehr Details
        dazu finden Sie bei der jeweils eingesetzten Kontaktart <br />
        🤝 Zweck: Abwicklung der Kommunikation <br />
        📅 Speicherdauer: Dauer des Geschäftsfalls und der gesetzlichen Vorschriften ⚖️
        Rechtsgrundlagen: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung), Art. 6 Abs. 1 lit. b DSGVO
        (Vertrag), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen) Wenn Sie mit uns Kontakt
        aufnehmen und per E-Mail oder Online-Formular kommunizieren, kann es zur Verarbeitung
      ...
      <p>
        ...
        auf dem E-Mail-Server. Die Daten werden gelöscht, sobald der Geschäftsfall beendet wurde und
        es gesetzliche Vorgaben erlauben.
      </p>
      <p>
        Online-Formular <br />
        Wenn Sie mit uns mittels Online-Formular kommunizieren, werden Daten an eine E-Mail-Adresse
        von uns weitergeleitet. Die Daten werden gelöscht, sobald der Geschäftsfall beendet wurde
        und es gesetzliche Vorgaben erlauben.
      </p>
      <!-- Eingebettete Social Media Elemente Datenschutzerklaerung -->
      <div class="text-h6 font-weight-bold mb-4">
        Eingebettete Social Media Elemente Datenschutzerklärung
      </div>
      <p>
        Wir binden auf unserer Webseite Elemente von Social Media Diensten ein um Bilder, Videos und
        Texte anzuzeigen. Durch den Besuch von Seiten die diese Elemente darstellen, werden Daten
        von Ihrem Browser zum jeweiligen Social Media Dienst übertragen und dort gespeichert. Wir
        haben keinen Zugriff auf diese Daten. Die folgenden Links führen Sie zu den Seiten der
        jeweiligen Social Media Dienste wo erklärt wird, wie diese mit Ihren Daten umgehen:
      </p>
      <p>
      ...
      <!-- Instagram -->
      <div class="text-h6 font-weight-bold mb-4">Instagram Datenschutzerklärung</div>
      <p>
        Instagram Datenschutzerklärung Zusammenfassung <br />
        ...
        Gerät und Ihre IP-Adresse. Mehr Details dazu finden Sie weiter unten in der
      ...
      <p>
        Instagram ist eines der bekanntesten Social Media Netzwerken weltweit. Instagram kombiniert
      ...
      <p>Warum verwenden wir Instagram auf unserer Website?</p>
      <p>
        Instagram ist jene Social Media Plattform, die in den letzten Jahren so richtig durch die
      ...
      <p>
        ...
        ist zu erwähnen, dass diese Berichte Sie nicht persönlich identifizieren.
      </p>
      <p>Welche Daten werden von Instagram gespeichert?</p>
      <p>
      ...
      <p>
        ...
        Instagram bereits von Ihnen hat, abgeglichen.
      </p>
      <p>
      ...
      <p>
        ...
        Facebook. Das bedeutet: wenn Sie ein Instagram-Konto haben oder
        <a
          href="http://www.instagram.com?tid=221149218"
          target="_blank"
        ...
        Berührung kommen. Spätestens nach 90 Tagen (nach Abgleichung) werden diese Daten wieder
        gelöscht bzw. anonymisiert. Obwohl wir uns intensiv mit der Datenverarbeitung von Instagram
        beschäftigt haben, können wir nicht ganz genau sagen, welche Daten Instagram exakt sammelt
        und speichert.
      </p>
      <p>
        Im Folgenden zeigen wir Ihnen Cookies, die in Ihrem Browser mindestens gesetzt werden, wenn
        ...
        eingeloggt sind, werden natürlich deutlich mehr Cookies in Ihrem Browser gesetzt.
      </p>
      ...
      <p>
        ...
        gesetzt, um Fälschungen von Anfragen zu verhindern. Genauer konnten wir das allerdings nicht
      ...
      <p>
        Name: urlgen<br />
        Wert: &#8220;{&#8220;194.96.75.33&#8243;: 1901}:1iEtYv:Y833k2_UjKvXgYe221149218&#8221;<br />
      ...
      <p>
        <a
          href="https://support.google.com/chrome/answer/95647?tid=221149218"
          target="_blank"
          class="external"
      ...
      <p>
        <a
          href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=221149218"
          target="_blank"
          class="external"
      ...
      <p>
        <a
          href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=221149218"
          target="_blank"
          class="external"
      ...
      <p>
        <a
          href="https://support.microsoft.com/de-at/help/17442/windows-internet-explorer-delete-manage-cookies?tid=221149218"
          target="_blank"
          rel="noopener noreferrer nofollow"
          class="external"
      ...
      <p>
        <a
          href="https://support.microsoft.com/de-at/help/4027947/windows-delete-cookies?tid=221149218"
          target="_blank"
          rel="noopener noreferrer nofollow"
          class="external"
      ...
      <p>
        ...
        unsichere Drittstaaten dürfen also nicht einfach übertragen, dort gespeichert und
        verarbeitet werden, sofern es keine passenden Garantien (wie etwa
        EU-Standardvertragsklauseln) zwischen uns und dem außereuropäischen Dienstleister gibt.
      </p>
      <p>Rechtsgrundlage</p>
      <p>
        ...
        und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und
        verarbeitet. Die meisten Social-Media-Plattformen setzen auch Cookies in Ihrem Browser, um
        Daten zu speichern. Darum empfehlen wir Ihnen, unseren Datenschutztext über Cookies genau
